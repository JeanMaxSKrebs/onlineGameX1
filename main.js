...
const municaoPlayer1 = new Projetil(Player1.meioX, Player1.meioY, Player1.estaEsquerda, 15, pixel / 3, pixel / 3)
const pistolaPlayer1 = new Arma("pistola", 8, municaoPlayer1, Player1.x, Player1.y)
Player1.setArma(pistolaPlayer1)

const municaoPlayer2 = new Projetil(Player2.meioX, Player2.meioY, Player2.estaEsquerda, 15, pixel / 3, pixel / 3)
